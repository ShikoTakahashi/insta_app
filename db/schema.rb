...
ActiveRecord::Schema.define(version: 2019_02_11_153459) do
  ...
  create_table "replayposts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["micropost_id"], name: "index_replayposts_on_micropost_id"
    t.index ["user_id"], name: "index_replayposts_on_user_id"
  end
